			...
			<div class=" flex items-center gap-1">
				...
				<div class="">
					...
					>
						...
						<!-- Cases (always visible for now) -->
						<a
							class="min-w-fit p-1.5 {$page.url.pathname.includes('/workspace/cases')
								? ''
								: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition"
						...
						<!-- Analysis (always visible for now) -->
						<a
							class="min-w-fit p-1.5 {$page.url.pathname.includes('/workspace/analysis')
								? ''
								: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition"
